...
<body style="background-color: #eeeee4;">
	...
	<div class="container d-flex">
		<form class="w-50 mx-auto shadow-lg p-3 mt-1" action="saveServlet"
			method="post">
			<h4 class="text-center">You can add notes</h4>
			<div class="mb-3">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<label for="selectOption" class="form-label">Select Notes
						Type</label> 
			...
			<div class="d-flex justify-content-center my-3">
				<button type="submit" class="btn btn-primary " onclick="sub()">Add Notes</button>
			</div>
		</form>
	</div>
