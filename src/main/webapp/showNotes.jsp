...
<title>show all notes page</title>
</head>
<body>
	<%@include file="navbar.jsp"%>

	<h4 class="text-center my-3">All Notes Are Here</h4>
				...
				<img src="data:image/png;base64, <%=new String(Base64.getEncoder().encode(note.getImage())) %>" class="card-img-top w-25 mx-auto" alt="...">
					<div class="card-body">
						...
						<div class="container text-center">
							<a href="update.jsp?note_id=<%= note.getId() %>" class="btn btn-success px-4">Update</a> 
							<a href="DeleteServlet?note_id=<%= note.getId() %>" class="btn btn-danger px-4">Delete</a>
						</div>
					</div>
				</div>
			</div>
